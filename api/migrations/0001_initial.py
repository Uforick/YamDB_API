# Generated by Django 3.0.5 on 2021-03-31 21:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, verbose_name='Название')),
                ('year', models.SmallIntegerField(validators=[api.validators.validate_year], verbose_name='Год выхода ("-" для года до н.э.)')),
